  ...
  return (
    <section id="about" className="relative z-10 w-full py-24 md:py-32" style={{ backgroundColor: "#F9F4F0" }}>
      <div className="container mx-auto px-8 md:px-16 lg:px-24 flex flex-col gap-12 md:gap-24">
        ...
        <div className="flex flex-col relative pb-[30vh]">
          {values.map((item, index) => (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-4 p-6 md:p-12 min-h-[auto] md:min-h-[500px]">
                ...
                <div className="md:col-span-5 lg:col-span-4 flex items-start justify-center md:justify-start relative -mt-8 md:-mt-16">
                  <div className="w-[80%] md:w-full max-w-[320px] md:max-w-none aspect-square relative z-10 ml-auto md:ml-0 bg-[#F9F4F0] border-[1.5px] border-[#282C37] overflow-hidden group">
                    ...
                    <div className="absolute bottom-8 md:bottom-12 right-full mr-2 md:mr-3 flex flex-col gap-1.5 md:gap-2 items-end z-20">
                      {item.tags.map((tag, i) => (
                ...
                <div className="md:col-span-5 lg:col-span-5 text-right flex flex-col pt-8 md:pt-0">
                  <motion.h3
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  <motion.p
                    ...
                    className="mt-4 md:mt-8 text-white font-body font-bold text-xs md:text-sm lg:text-base uppercase tracking-widest"
                  >
                    {item.subtitle}
                  </motion.p>
                  ...
                  <motion.p
                    ...
                    className="mt-6 md:mt-10 text-white/90 font-body text-sm md:text-base lg:text-lg max-w-2xl leading-[1.7] md:leading-[1.8]"
                  >
                    {item.desc}
                  </motion.p>
                </div>
